...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **34개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **76개 승인됨**. 승인 대기 0개.
...
| [M04](./M04-auth/) 인증·계정 | Google OAuth, JWT, RBAC, 데모 발급·정리, 입점, 테스트 기반 | 9/14 |
...
<details><summary><b>M04. 인증·계정</b> (9/14)</summary>
...
<details><summary><b>M05. 카탈로그</b> (8/13)</summary>
