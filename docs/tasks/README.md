...
전체 **105개** TASK. **M01 7개 완료**, TASK-0014 · TASK-0020 **승인됨**, 나머지 96개는 **승인 대기** 상태다.
...
| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0014](./M03-design-system/TASK-0014-design-tokens.md) | 디자인 토큰 · 밀도 3단계 | 승인됨 |
...
| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0020](./M04-auth/TASK-0020-user-schema.md) | 사용자 · 역할 스키마 | 승인됨 |
