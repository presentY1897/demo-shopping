...
아래 인덱스에 등록된 **139개** TASK: **130개 완료**, **7개 진행중**, **2개 승인됨**, **0개 초안**. TASK-0124 검토 완료 후 TASK-0125~0131을 후속 작업으로 작성하고 사용자 승인을 받았다. 폐기 TASK는 이 집계에 포함하지 않는다.

| 마일스톤 | 범위 | 진행 |
| --- | --- | --- |
| [M01](./M01-foundation/) 기반 구축 | 워크스페이스, 공유 설정, 로컬 인프라, API/웹 부트스트랩, CI | **7/7 완료** |
| [M02](./M02-deployment/) 배포 파이프라인 | 도메인, Vercel×3, Railway, R2, 자동 배포, 관측, 콜드 스타트 | 4/9 |
...
| [M06](./M06-search/) 검색·탐색 | Meilisearch 인덱싱, 검색 API, 3단계 뷰, SEO, 한글 자동완성 | **10/10 완료** |
...
| [M15](./M15-polish/) 마무리 | 성능·정합성, 접근성, E2E·데모 시나리오, 포트폴리오 문서 | 22/26 |
...
<details><summary><b>M02. 배포 파이프라인</b> (4/9)</summary>
...
| [TASK-0010](./M02-deployment/TASK-0010-frontend-deploy.md) | 프론트 배포 (Vercel × 3) | 완료 |
...
<details><summary><b>M03. 디자인 시스템</b> (7/7 완료)</summary>
...
| [TASK-0018](./M03-design-system/TASK-0018-shop-layout.md) | shop 레이아웃 · 밀도 토글 | 완료 |
| [TASK-0019](./M03-design-system/TASK-0019-console-layout.md) | 콘솔 레이아웃 (seller · admin) | 완료 |
...
| [TASK-0109](./M04-auth/TASK-0109-seller-onboarding-page.md) | 판매자 입점 신청 · 스토어 설정 화면 | 완료 |
| [TASK-0110](./M04-auth/TASK-0110-seller-review-admin.md) | 관리자 입점 심사 화면 | 완료 |
| [TASK-0111](./M04-auth/TASK-0111-profile-address-api.md) | 프로필 · 배송지 · 사용자 설정 API | 완료 |
| [TASK-0112](./M04-auth/TASK-0112-profile-address-page.md) | 프로필 · 배송지 화면 | 완료 |
...
<details><summary><b>M05. 카탈로그</b> (13/13 완료)</summary>
...
| [TASK-0117](./M05-catalog/TASK-0117-error-contract.md) | 오류 전달 계약 · 사용자 언어 정리 | 완료 |
| [TASK-0031](./M05-catalog/TASK-0031-attribute-admin.md) | 관리자 속성 관리 화면 | 완료 |
| [TASK-0032](./M05-catalog/TASK-0032-product-schema.md) | 상품 · 옵션 · Variant 스키마 | 완료 |
| [TASK-0033](./M05-catalog/TASK-0033-image-upload.md) | 이미지 업로드 위젯 | 완료 |
| ~~TASK-0034~~ | ~~판매자 상품 등록 · 수정~~ | **폐기** → 0113 · 0114 |
| ~~TASK-0035~~ | ~~판매자 상품 목록 · 재고 관리~~ | **폐기** → 0115 · 0116 |
| [TASK-0113](./M05-catalog/TASK-0113-product-write-api.md) | 상품 등록 · 수정 API | 완료 |
| [TASK-0114](./M05-catalog/TASK-0114-product-editor-page.md) | 판매자 상품 편집기 화면 | 완료 |
| [TASK-0115](./M05-catalog/TASK-0115-product-list-stock-api.md) | 판매자 상품 목록 · 재고 조정 API | 완료 |
| [TASK-0116](./M05-catalog/TASK-0116-product-list-stock-page.md) | 판매자 상품 목록 · 재고 관리 화면 | 완료 |
| [TASK-0036](./M05-catalog/TASK-0036-stock-ledger.md) | 재고 원장 | 완료 |
| [TASK-0037](./M05-catalog/TASK-0037-seed-data.md) | 시드 데이터 생성기 | 완료 |

</details>

<details><summary><b>M06. 검색·탐색</b> (10/10 완료)</summary>
...
<details><summary><b>M07. 장바구니·주문</b> (7/7 완료)</summary>

| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0045](./M07-cart-order/TASK-0045-cart-api.md) | 장바구니 스키마 · API | 완료 |
| [TASK-0046](./M07-cart-order/TASK-0046-cart-page.md) | 장바구니 화면 (판매자별 그룹) | 완료 |
| [TASK-0047](./M07-cart-order/TASK-0047-pricing-engine.md) | 금액 계산 엔진 | 완료 |
| [TASK-0048](./M07-cart-order/TASK-0048-stock-reservation.md) | 재고 예약 | 완료 |
| [TASK-0049](./M07-cart-order/TASK-0049-order-create.md) | 주문 생성 API (2단 분할) | 완료 |
| [TASK-0050](./M07-cart-order/TASK-0050-checkout-page.md) | 주문서 화면 | 완료 |
| [TASK-0051](./M07-cart-order/TASK-0051-reservation-expiry.md) | 예약 만료 스케줄러 | 완료 |
...
| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0052](./M08-payment/TASK-0052-payment-abstraction.md) | PaymentProvider 추상화 · 결제 스키마 | 완료 |
...
<details><summary><b>M09. 배송·주문관리</b> (6/6 완료)</summary>
...
| [TASK-0062](./M09-fulfillment/TASK-0062-delivery-simulator.md) | 배송 상태 자동 진행 시뮬레이터 | 완료 |
| [TASK-0063](./M09-fulfillment/TASK-0063-buyer-orders.md) | 구매자 주문 내역 · 상세 | 완료 |
| [TASK-0064](./M09-fulfillment/TASK-0064-order-confirm.md) | 구매확정 (수동 · 자동) | 완료 |

</details>

<details><summary><b>M10. 취소·반품·환불</b> (7/7 완료)</summary>

| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0065](./M10-claims/TASK-0065-claim-schema.md) | 클레임 스키마 · 상태 머신 | 완료 |
| [TASK-0066](./M10-claims/TASK-0066-cancel-flow.md) | 취소 신청 · 처리 (부분) | 완료 |
| [TASK-0067](./M10-claims/TASK-0067-return-flow.md) | 반품 신청 · 수거 · 검수 (부분) | 완료 |
| [TASK-0068](./M10-claims/TASK-0068-refund-calc.md) | 환불 안분 계산 · 실행 | 완료 |
| [TASK-0069](./M10-claims/TASK-0069-stock-restore.md) | 재고 복원 | 완료 |
| [TASK-0070](./M10-claims/TASK-0070-seller-claims.md) | 판매자 클레임 처리 화면 | 완료 |
| [TASK-0071](./M10-claims/TASK-0071-admin-claims.md) | 관리자 클레임 개입 | 완료 |

</details>

<details><summary><b>M11. 할인</b> (7/7 완료)</summary>

| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0072](./M11-discount/TASK-0072-coupon-schema.md) | 쿠폰 스키마 · 발행 API | 완료 |
| [TASK-0073](./M11-discount/TASK-0073-platform-coupon-admin.md) | 관리자 플랫폼 쿠폰 화면 | 완료 |
| [TASK-0074](./M11-discount/TASK-0074-seller-coupon.md) | 판매자 쿠폰 화면 | 완료 |
...
| [TASK-0077](./M11-discount/TASK-0077-coupon-point-pages.md) | 쿠폰함 · 적립금 내역 화면 | 완료 |
| [TASK-0078](./M11-discount/TASK-0078-discount-restore.md) | 환불 시 쿠폰 · 적립금 복구 | 완료 |

</details>

<details><summary><b>M12. 정산</b> (5/5 완료)</summary>
...
| [TASK-0120](./M12-settlement/TASK-0120-settlement-clock.md) | 정산 줄의 시각을 주입된 시계로 | 완료 |
...
<details><summary><b>M15. 마무리</b> (22/26)</summary>
...
| [TASK-0129](./M15-polish/TASK-0129-purchase-ux-consistency.md) | 구매 안내·오류 피드백·모바일 동선 정리 | 완료 |
...
| [TASK-0136](./M15-polish/TASK-0136-neon-region-alignment.md) | Neon DB와 API 리전 일치 | 완료 |
| [TASK-0137](./M15-polish/TASK-0137-product-thumbnail-consistency.md) | 세 앱 상품 썸네일 표시 통합 | 진행중 |
| [TASK-0138](./M15-polish/TASK-0138-product-thumbnail-generation.md) | 상품 이미지 자동 썸네일 생성과 데이터 연결 | 진행중 |
| [TASK-0139](./M15-polish/TASK-0139-demo-seller-search-visibility.md) | 데모 셀러 초기 상품의 구매자 검색 노출 복구 | 완료 |
| [TASK-0140](./M15-polish/TASK-0140-demo-transaction-fixtures.md) | 역할별 데모 거래 초기 데이터 보완 | 완료 |
| [TASK-0141](./M15-polish/TASK-0141-cross-role-demo-e2e.md) | 세 역할이 연결되는 데모 거래 E2E 검증 | 완료 |
| [TASK-0142](./M15-polish/TASK-0142-production-image-import-guard.md) | 운영 상품 이미지 반영 가드와 실행 기록 (사후 문서) | 완료 |
