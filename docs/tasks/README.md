...
전체 **121개** TASK — 유효 **117개** + 폐기 4개(D-208 레이어 분할). **54개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **60개 승인됨**. TASK-0123(구매자 메인 설명 정리) 진행중.
...
| [M15](./M15-polish/) 마무리 | 성능·정합성, 접근성, E2E·데모 시나리오, 포트폴리오 문서 | 5/7 |
...
<details><summary><b>M15. 마무리</b> (5/7)</summary>
...
| [TASK-0123](./M15-polish/TASK-0123-storefront-copy-cleanup.md) | 구매자 메인 설명 정리 | 진행중 (구현·로컬 검증 완료) |
