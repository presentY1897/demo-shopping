...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **45개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **65개 승인됨**. 승인 대기 0개.
...
| [M07](./M07-cart-order/) 장바구니·주문 | 장바구니, 금액 계산 엔진, 재고 예약, 주문 2단 분할 | 6/7 |
...
<details><summary><b>M07. 장바구니·주문</b> (6/7)</summary>
