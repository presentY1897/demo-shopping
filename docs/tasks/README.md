...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **50개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **60개 승인됨**. 승인 대기 0개.
...
| [M12](./M12-settlement/) 정산 | 수수료 정책, 정산서 배치, 승인·지급, 매출 대시보드 | 1/4 |
...
<details><summary><b>M12. 정산</b> (1/4)</summary>
