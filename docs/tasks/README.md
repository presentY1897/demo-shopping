...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **26개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **84개 승인됨**. 승인 대기 0개.
...
| [M05](./M05-catalog/) 카탈로그 | 카테고리·속성 정의, 상품·SKU, 이미지, 재고 원장, 시드 | 5/13 |
...
<details><summary><b>M05. 카탈로그</b> (5/13)</summary>
