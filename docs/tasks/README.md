...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **49개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **61개 승인됨**. 승인 대기 0개.
...
| [M08](./M08-payment/) 결제 | 프로바이더 추상화, 가상 카드, 토스 연동, 웹훅, 실패 복구 | 3/7 |
...
<details><summary><b>M08. 결제</b> (3/7)</summary>
