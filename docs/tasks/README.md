...
전체 **117개** TASK — 유효 **113개** + 폐기 4개(D-208 레이어 분할). **46개 완료**, TASK-0009 · TASK-0011 **진행중**(외부 계정 대기), **64개 승인됨**. 승인 대기 0개.
...
| ID | 제목 | 상태 |
| --- | --- | --- |
| [TASK-0052](./M08-payment/TASK-0052-payment-abstraction.md) | PaymentProvider 추상화 · 결제 스키마 | 승인됨 |
