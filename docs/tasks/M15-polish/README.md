...
| [TASK-0100](./TASK-0100-portfolio-docs.md) | README · 포트폴리오 문서 | 진행중 | 0097, 0098, 0099 |
...
| [TASK-0146](./TASK-0146-perf-timing-gate.md) | 성능 검사의 시간 기준을 러너에서 떼어 낸다 — CI 는 느슨하게, 300ms 는 푸시 전에 | 완료 | 0097 |
