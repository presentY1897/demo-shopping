# M05. 카탈로그 — 완료 (2026-09-05)

카테고리·속성·상품·재고를 만든다. **"코드 수정 없이 카테고리와 속성을 추가할 수 있어야 한다"(D-005)의 실현 지점**이다.

이 마일스톤부터 **커버리지 게이트(Q5, 80%)가 적용**된다.

**완료 조건**: 관리자가 화면에서 카테고리와 속성을 만들고, 판매자가 그 정의로 자동 생성된 폼으로 상품을 등록하며, 시드 데이터 800개가 들어간다. — **충족**. 시드는 판매자 15 · 카테고리 40 · 상품 800 · 조합 3,595 를 넣고(TASK-0037), 판매자는 그 상품을 목록에서 관리하고 재고를 조정량으로 움직인다(TASK-0116).
...
| [TASK-0114](./TASK-0114-product-editor-page.md) | 판매자 상품 편집기 화면 | 완료 | 0113, 0033, 0017, 0019, 0023, 0107 |
| [TASK-0115](./TASK-0115-product-list-stock-api.md) | 판매자 상품 목록 · 재고 조정 API | 완료 | 0113, 0036, 0106 |
| [TASK-0116](./TASK-0116-product-list-stock-page.md) | 판매자 상품 목록 · 재고 관리 화면 | 완료 | 0115, 0016, 0019, 0023, 0107 |
