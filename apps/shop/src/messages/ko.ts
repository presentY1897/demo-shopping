...
export const ko: Messages = {
  ...
  guide: {
    ...
    steps: [
      {
        title: '① 판매할 스토어를 만든다',
        body: '판매자 콘솔에서 데모 계정을 받습니다. 상품 12개와 체험 주문이 준비됩니다. 내 스토어 이름과 구매할 상품 이름을 확인하고 이 탭을 열어 두세요.',
        minutes: 1,
        app: 'seller',
        path: '/login',
      },
      {
        title: '② 그 판매자의 상품을 산다',
        body: '상점 탭에서 구매자 데모를 받고 상품 이름으로 검색하세요. 판매자 필터와 상세의 스토어 이름이 첫 탭과 같은지 확인한 뒤 장바구니에서 가상 카드로 결제합니다. 주문번호를 기억해 두세요. 부분 취소는 두 상품을 주문한 뒤 발송 전에 체험할 수 있습니다.',
        minutes: 2,
        app: 'shop',
        path: '/login',
      },
      {
        title: '③ 같은 주문을 발송한다',
        body: '처음 연 판매자 탭의 주문 목록에서 방금 구매한 주문번호를 찾습니다. 주문 확인 후 발송 처리하세요. 구매자 주문 상세에서 배송조회 버튼을 누르면 같은 가상 운송장을 볼 수 있습니다. 배송완료 후에는 반품을 신청할 수 있습니다.',
        minutes: 1,
        app: 'seller',
        path: '/orders',
      },
      {
        title: '④ 관리자가 같은 거래를 확인한다',
        body: '관리자 탭에서 데모 계정을 받고 주문 관리에서 같은 주문번호를 검색하세요. 금액과 배송 상태를 대조할 수 있습니다. 상품 관리에서는 해당 데모 상품을 검색해 내리기·다시 올리기를 체험합니다. 정산 승인과 클레임 개입은 별도로 준비된 체험 예제를 사용하세요.',
        minutes: 1,
        app: 'admin',
        path: '/login',
      },
  ...
  productDetail: {
    ...
    purchase: {
      ...
      addToCart: '장바구니 담기',
      buyNow: '바로 구매',
      buyFailed: '주문서를 열지 못했어요. 옵션과 재고를 확인한 뒤 다시 시도해 주세요.',
    ...
    info: {
      ...
      shippingThreshold: '이 판매자의 할인 적용 후 상품금액 {amount} 이상 무료배송',
      shippingUnknown: '배송비는 주문서에서 확인할 수 있어요.',
  ...
  checkout: {
    ...
    cancelFailed: '주문서를 취소하지 못했어요. 다시 시도해 주세요.',
    retryDraft: '다시 시도',
    ...
    payment: {
      ...
      loadFailed: '카드 목록을 불러오지 못했어요.',
      reloadCards: '카드 목록 다시 불러오기',
