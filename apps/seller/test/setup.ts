 ...
 * without them the product editor's category picker throws on open rather than
 * failing an assertion (`apps/admin/test/setup.ts` and
 * `packages/ui/test/setup.ts` carry the same four, for the same control).
 */
