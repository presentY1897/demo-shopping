...
import type {
  ...
  CouponFilterMessages,
  CouponFormFieldMessages,
  CouponFormMessages,
  CouponIssuingMessages,
  CouponLiabilitySummaryMessages,
  CouponListMessages,
  CouponSettlementMessages,
  CouponTableMessages,
  CouponVocabularyMessages,
  CouponWarningMessages,
  DemoMessages,
  ...
  NotificationItemMessages,
  NotificationMenuMessages,
  NotificationPageMessages,
  ...
  QuestionAnswerConfirmMessages,
  QuestionAnswerMessages,
  QuestionAnswerRefusalMessages,
  QuestionCardMessages,
  QuestionFilterMessages,
  QuestionListMessages,
  QuestionUnansweredMessages,
  RevenueChartMessages,
  RevenueComparisonMessages,
  RevenueDashboardMessages,
  RevenueFilterMessages,
  RevenueTopProductMessages,
  RevenueTotalsMessages,
  ReviewCardMessages,
  ReviewFilterMessages,
  ReviewListMessages,
  ReviewReplyConfirmMessages,
  ReviewReplyMessages,
  ReviewReplyRefusalMessages,
  ReviewUnansweredMessages,
  RouteStateMessages,
  SearchReadinessMessages,
  SettlementCalculationMessages,
  SettlementDetailMessages,
  SettlementFilterMessages,
  SettlementItemMessages,
  SettlementListMessages,
  SettlementOutlookMessages,
  SettlementSummaryMessages,
  SettlementTableMessages,
  SettlementTotalsMessages,
  SettlementVocabularyMessages,
  SignInMessages,
  StoreAbsentMessages,
