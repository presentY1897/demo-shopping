...
export const ko: Messages = {
  ...
  orders: {
    ...
    actionLabels: {
      PAYMENT_PENDING: '결제 대기로',
      PAYMENT_FAILED: '결제 실패로',
      PAID: '결제완료로',
      PREPARING: '주문 확인',
      SHIPPED: '발송 처리',
      DELIVERED: '배송완료 처리',
  ...
  orderList: {
    title: '주문 관리',
    description: '들어온 주문을 확인하고 발송까지 처리합니다.',
    loadingLabel: '주문 목록을 불러오는 중입니다',
    tabs: {
      label: '주문 상태로 걸러 보기',
      names: {
        all: '전체',
    ...
    filters: {
      ...
      fromLabel: '시작일',
      toLabel: '종료일',
      searchLabel: '주문번호·수령인 검색',
      searchPlaceholder: '주문번호나 수령인 이름 일부',
      reset: '조건 지우기',
      rangeReversed: '종료일이 시작일보다 빠릅니다.',
    },
    table: {
      caption: '들어온 주문 목록',
      orderNumber: '주문번호',
      ...
      tracking: '운송장',
      actions: '관리',
      selectRow: '{orderNumber} 선택',
      selectAll: '이 페이지 전체 선택',
      open: '상세',
      noTracking: '발송 전',
      headlineWithRest: '{headline} 외 {rest}건',
      quantity: '{count}개',
    },
    badges: {
      actionRequired: '처리 대기 {count}건',
      newOrders: '신규 주문 {count}건',
      none: '처리할 주문이 없습니다',
    },
    bulk: {
      ...
      export: '엑셀 내보내기',
      exporting: '내보내는 중',
      exported: '{count}건을 내려받았습니다.',
      exportEmpty: '내보낼 주문이 없습니다.',
      exportColumns: {
        orderNumber: '주문번호',
        orderedAt: '주문일시',
        status: '상태',
    ...
    ship: {
      title: '발송 처리할까요?',
      bulkTitle: '{count}건을 한 번에 발송 처리할까요?',
      carrierLabel: '운송사',
      carrierAuto: '자동 배정',
      notice: '가상 운송장이 발급되고 구매자 화면에 즉시 배송중으로 보입니다.',
      confirm: '발송 처리',
      cancel: '취소',
      done: '{count}건을 발송 처리했습니다.',
      partial: '{done}건을 처리했고 {failed}건이 실패했습니다.',
      failedHeading: '처리하지 못한 주문',
      nothingShippable: '선택한 주문 중 발송할 수 있는 건이 없습니다.',
    },
    pagination: {
      label: '주문 목록 페이지 이동',
      previous: '이전',
    ...
    empty: {
      ...
      description: '주문이 들어오면 여기에서 확인하고 발송까지 처리할 수 있습니다.',
    },
    filteredEmpty: {
      title: '조건에 맞는 주문이 없어요.',
      description: '탭이나 기간, 검색어를 바꿔 보세요.',
    },
    errorTitle: '주문 목록을 불러오지 못했습니다.',
    retry: '다시 시도',
    failure: {
      title: '요청을 처리하지 못했습니다.',
      copyLabel: '요청 번호 복사',
      copiedLabel: '복사했습니다',
      requestIdLabel: '요청 번호',
      requestIdHint: '문의할 때 이 번호를 알려 주세요.',
      retryLabel: '다시 시도',
    },
    toast: {
      regionLabel: '주문 처리 알림',
      closeLabel: '알림 닫기',
  ...
  orderDetail: {
    title: '주문 상세',
    description: '한 건의 주문을 확인하고 상태를 옮깁니다.',
    ...
    amounts: {
      productAmount: '상품금액',
      couponDiscountAmount: '쿠폰 할인',
      pointDiscountAmount: '적립금 사용',
      shippingFee: '배송비',
      paidAmount: '결제금액',
    },
    actions: {
      legend: '이 주문에 할 수 있는 것',
      blocked: '{requirement}',
      blockedUnknown: '지금은 처리할 수 없습니다.',
      reasonLabel: '사유',
      reasonPlaceholder: '왜 이렇게 처리하는지 적어 주세요',
      reasonRequired: '사유를 입력해 주세요.',
      confirmTitle: '이대로 처리할까요?',
      confirmBody: "'{action}' 을(를) 실행합니다.",
      confirm: '처리하기',
      cancel: '취소',
      done: '{status} 상태로 바꿨습니다.',
      unchanged: '이미 처리돼 있었습니다.',
    },
    tracking: {
      carrier: '운송사',
      trackingNumber: '운송장번호',
      virtualNotice: '이 배송 정보는 가상입니다. 실제 운송사 조회창에서는 찾을 수 없습니다.',
      shippedAt: '발송일시',
      deliveredAt: '배송완료일시',
      copyTrackingNumber: '운송장번호 복사',
      notShippedTitle: '아직 발송 전이에요.',
      notShippedDescription: '발송 처리를 하면 가상 운송장이 발급됩니다.',
      noEventsTitle: '추적 정보가 아직 없어요.',
      noEventsDescription: '배송이 움직이면 여기에 기록이 쌓입니다.',
      progressLabel: '배송 진행',
      status: {
        READY: '집화 완료',
        IN_TRANSIT: '이동 중',
    ...
    copiedTrackingNumber: '운송장번호를 복사했습니다.',
    history: {
      title: '상태 이력',
      caption: '이 주문이 지나온 상태',
      at: '시각',
      change: '변경',
      actor: '처리 주체',
      reason: '사유',
    ...
    print: {
      ...
      paidAmount: '결제금액',
      tracking: '운송장번호',
      notice: '가상 데모 주문서입니다. 실제 거래 증빙이 아닙니다.',
    },
    ship: {
      title: '발송 처리할까요?',
      bulkTitle: '{count}건을 한 번에 발송 처리할까요?',
    ...
    errorTitle: '주문을 불러오지 못했습니다.',
    retry: '다시 시도',
    notFound: {
      title: '주문을 찾을 수 없어요.',
      description: '이미 처리됐거나 다른 스토어의 주문일 수 있습니다.',
    },
    failure: {
      title: '요청을 처리하지 못했습니다.',
      copyLabel: '요청 번호 복사',
  ...
  claims: {
    ...
    actionLabels: {
      CANCEL_REQUESTED: '취소 신청으로',
      CANCEL_APPROVED: '취소 승인',
      CANCEL_REJECTED: '취소 거절',
      RETURN_REQUESTED: '반품 신청으로',
      RETURN_APPROVED: '반품 승인',
      PICKING_UP: '회수 처리',
      INSPECTING: '입고 처리',
      RETURN_COMPLETED: '반품 완료 처리',
      RETURN_REJECTED: '반품 거절',
      REFUNDED: '환불 처리',
    },
    inspectionLabels: {
  ...
  claimList: {
    title: '취소·반품',
    description: '들어온 취소·반품을 확인하고 승인부터 입고 검수까지 처리합니다.',
    loadingLabel: '취소·반품 목록을 불러오는 중입니다',
    tabs: {
      label: '처리 단계로 걸러 보기',
      names: {
        all: '전체',
    ...
    badges: {
      // 탭의 「처리 대기 5건」과 **다른 문장**이어야 한다. 탭은 단계의 이름이고 이것은
      // 「내 가게에 지금 손댈 것이 몇 건인가」라, 같은 글자를 쓰면 화면에 같은 문장이
      // 두 번 나와 보조 기술이 그것을 두 번 읽는다.
      waiting: '지금 처리할 것 {count}건',
      none: '지금 처리할 것이 없습니다',
    },
    deadline: {
      overdue: '기한 초과',
      rule: '처리 기한은 신청 후 2영업일입니다. 주말 제외 · 공휴일은 반영하지 않습니다.',
    },
    pagination: {
      label: '취소·반품 목록 페이지 이동',
      previous: '이전',
      next: '다음',
      page: '{page} 페이지',
    },
    empty: {
      title: '아직 들어온 취소·반품이 없어요.',
      description: '구매자가 취소나 반품을 신청하면 여기에서 처리할 수 있습니다.',
    },
    filteredEmpty: {
      title: '조건에 맞는 취소·반품이 없어요.',
      description: '탭이나 유형, 상태를 바꿔 보세요.',
    },
    errorTitle: '취소·반품 목록을 불러오지 못했습니다.',
    retry: '다시 시도',
  },
  claimDetail: {
    title: '취소·반품 상세',
    description: '한 건의 취소·반품을 확인하고 승인부터 입고 검수까지 처리합니다.',
    loadingLabel: '취소·반품을 불러오는 중입니다',
    backToList: '취소·반품 목록으로',
    subtitle: '주문번호 {orderNumber}',
    sections: {
      items: '대상 상품',
      request: '신청 내용',
    ...
    quote: {
      pendingTitle: '환불 예정액',
      refundedTitle: '환불된 금액',
      itemsAmount: '상품 환불액',
      shippingAmount: '배송비 조정',
      total: '합계',
      pendingNotice: '실제 환불과 같은 계산입니다. 승인하면 이 금액이 구매자에게 나갑니다.',
      refundedNotice: '이미 구매자에게 지급된 금액입니다.',
    },
    photos: {
      empty: '첨부된 사진이 없습니다.',
      alt: '구매자가 첨부한 사진 {index}',
      unavailable: '이미지를 표시할 수 없습니다.',
    },
    fault: {
      returnReason: '반품 사유',
      fault: '귀책',
      returnShippingDeduction: '반품 배송비 차감',
      originalShippingRefund: '원 배송비 환불',
      readOnlyNotice:
        '귀책은 구매자가 고른 반품 사유에서 정해져 신청 시점에 굳습니다. 여기서는 바꿀 수 없고, 판매자의 판단은 입고 검수의 합격·불합격으로 남습니다.',
    },
    shipments: {
      pickup: '회수 운송장',
      sendBack: '반송 운송장',
    ...
    deadline: {
      ...
      onTime: '기한 안',
      rule: '처리 기한은 신청 후 2영업일입니다. 주말 제외 · 공휴일은 반영하지 않습니다.',
      overdueNotice: '처리 기한 {due} 이(가) 지났습니다. 구매자가 기다리고 있어요.',
    },
    history: {
      caption: '이 신청이 지나온 상태',
      at: '시각',
      change: '변경',
      actor: '처리 주체',
      reason: '사유',
    ...
    actions: {
      legend: '이 신청에 할 수 있는 것',
      empty: '지금 판매자가 할 일은 없습니다.',
      confirmTitle: '이대로 처리할까요?',
      confirmBody: "'{action}' 을(를) 실행합니다.",
      confirm: '처리하기',
      cancel: '취소',
      reasonLabel: '거절 사유',
      reasonPlaceholder: '왜 거절하는지 적어 주세요. 구매자에게 그대로 전달됩니다',
      reasonRequired: '거절 사유를 입력해 주세요.',
      noteLabel: '불합격 사유',
      notePlaceholder: '어디가 문제였는지 적어 주세요. 구매자에게 그대로 전달됩니다',
      noteRequired: '불합격 사유를 입력해 주세요.',
      done: '{status} 상태로 바꿨습니다.',
      unchanged: '이미 처리돼 있었습니다.',
    },
    errorTitle: '취소·반품을 불러오지 못했습니다.',
    retry: '다시 시도',
    notFound: {
      title: '취소·반품을 찾을 수 없어요.',
      description: '이미 처리됐거나 다른 스토어의 신청일 수 있습니다.',
    },
    failure: {
      title: '요청을 처리하지 못했습니다.',
      copyLabel: '요청 번호 복사',
