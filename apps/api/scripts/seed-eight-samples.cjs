// Register the reviewed eight samples only in the isolated local preview database.
...
const lanes = ['a', 'b', 'c']
const manifestFolders = ['eight-a-v1', 'eight-b-v1', 'eight-c-v1']
...
const specs = JSON.parse(
  readFileSync(resolve(root, 'product-images/eight-v1.json'), 'utf8'),
).products
const categorySlugs = {
  가방: 'lifestyle-bags',
...
async function main() {
  ...
  try {
    ...
    writeFileSync(
      resolve(root, 'product-images/eight-products.json'),
