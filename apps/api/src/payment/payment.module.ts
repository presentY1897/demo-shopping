...
import { PaymentStragglerService } from './payment-straggler.service.js'
...
@Module({
  ...
  providers: [
    ...
    // 낙오된 결제를 끝낸다 (TASK-0057 F2 · F6 · D-221). 대사와 나란히 서지만
    // **찾는 것이 반대 방향으로 둘**이다 — 매입이 끝났는데 주문이 안 끝난 건은
    // 마저 끝내고, 매입 없이 남은 승인은 되감는다.
    PaymentStragglerService,
